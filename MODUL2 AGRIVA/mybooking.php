            ...
            <table class=" table css-serial">
                ...
                <tr>
                    ...
                    if($_POST['roomtype'] == "standard"){
                     $total = $_POST['duration'] * 90;
                    }
                    elseif($_POST['roomtype'] == "superior"){
                        $total = $_POST['duration'] * 150;
                    }
                    elseif($_POST['roomtype'] == "luxury"){
                        $total = $_POST['duration'] * 200;
                    }
                    foreach($service as $b){ 
                            $b= str_replace('Room Service','20',$b);
                            $b= str_replace('Breakfast','20',$b);
                            $totalservice += $b;
                        }
                    $sum = $total+$totalservice;
                    echo '$'.$sum;
                            ?> 
                    </td>
            </table>
